...
void batchGradientDescent::evaluatePolicy(Agent& agent) {
...
void batchGradientDescent::improvePolicyGreedy(Agent& agent) {
...
void batchGradientDescent::run(Agent& agent) {
